...
return [
    ...
    'users_external_auth_id_desc' => 'When using external authentication system, this ID is used to match this user with the external authentication system.',
    'users_discord_id' => 'Discord ID',
    'users_discord_id_desc' => 'The Discord user ID that will be included in webhook payloads when this user performs actions.',
